...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = '[WPKAN] Long Sequences Forecasting')
    
    ''' frequent changing hy.params '''
    parser.add_argument('--model', type = str, required = False, choices = ['WPKAN'], default = 'WPKAN',help = 'model of experiment')
