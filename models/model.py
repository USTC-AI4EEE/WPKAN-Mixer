...
import numpy as np
from models.wavelet_patch_mixer import WPKANCore

class WPKANWrapperShortTermForecast(nn.Module):
    def __init__(self,
                 c_in = [], 
                 c_out = [],
                 seq_len = [],
                ...
                no_decomposition = [],
                use_amp = []):
        super(WPKANWrapperShortTermForecast, self).__init__()
        self.model = WPKAN(c_in = c_in, c_out = c_out, seq_len = seq_len, out_len = out_len, d_model = d_model,
...
class WPKAN(nn.Module):
    def __init__(self,
        ...
        self.wpkanCore = WPKANCore(input_length = self.actual_seq_len,
